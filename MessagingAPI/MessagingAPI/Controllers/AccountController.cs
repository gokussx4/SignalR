...
namespace MessagingAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            IdentityUser<int, AngIndyUserLogin, AngIndyUserRole, AngIndyUserClaim> user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
